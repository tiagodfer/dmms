...
public class Allocator extends Thread {
    ...
    public Allocator (int MAX_OCCUPATION, int MAX_FRAGMENTATION, int REQ_NUMBER, Semaphore lock, Semaphore empty, Semaphore full, Semaphore lockHeap, Deallocator deallocator, Defragger defragger, Queue queue, Heap heap) {
